...
<html lang="zxx">
  <head>
    <title>SDN 15 Padang Pasir</title>
    <!--meta tags -->
    <meta charset="UTF-8">
  ...
  <body>
    <div class="main-top" id="home" style="background: url(images/b2.jpg) no-repeat center;background-size: cover;">
      <!-- header -->
      <div class="headder-top" style="background:  black ; opacity: 0.5;">
        <!-- nav -->
        <nav >
          <div id="logo">
            <h1><a href="index.php">SDN 15 Padang Pasir</a></h1>
          </div>
