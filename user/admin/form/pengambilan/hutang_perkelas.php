...
<div class="box-header with-border">
  <h3 class="box-title">
    Data Hutang Piutang Kelas <?php echo $d1['tingkat'].' - ' .$d1['nama_kelas'] ?> <br>
    Tahun Ajaran <?php echo $dta['nama_ta'] ?>

  </h3>
<div class="pull-right">

    <a href="form/pengambilan/print_hutang_perkelas.php?id_kelas=<?php echo $id ?>&id_ta=<?php echo $id_ta ?>" class=" btn btn-info btn-sm" target="_blank">Print Hutang Piutang Kelas <?php echo $d1['tingkat'].' - ' .$d1['nama_kelas'] ?> Tahun Ajaran <?php echo $dta['nama_ta'] ?></a>
