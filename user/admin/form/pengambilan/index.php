<div class="box-header with-border">
  ...
  <div class="box-tools pull-right">
    ...
    <a href="" class=" btn btn-info btn-sm"  data-toggle="modal" data-target="#cari_ta">Cari Hutang Per Tahun Ajaran</a>
...
<form action="?a=hutang_per_tahun_ajaran" method="post"  enctype="multipart/form-data">
<div class="modal fade" id="cari_ta">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Cari Hutang Per Tahun Ajaran</h4>
              </div>
              <div class="modal-body">
