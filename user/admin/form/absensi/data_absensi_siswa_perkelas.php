...
<div class="col-md-8">
  <div class="box-header with-border">
   ...
   <div class="pull-right">
     <a href="form/absensi/print_absensi_perkelas.php?id_kelas=<?php echo   $id_kelas ?>&id_ta=<?php echo $id_ta_aktif  ?>&semester=<?php echo $semester_ke ?>" class="btn btn-info btn-sm" target="_blank">Print</a>
   </div>
  </div>
